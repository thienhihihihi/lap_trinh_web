...
<div class="header-container">
    ...
    <div class="search-bar">
        <button type="button" class="search-btn" onclick="toggleSearchSidebar()">
            <i class="fa-solid fa-magnifying-glass fa-lg"></i>
        </button>
        <input type="text" name="query" placeholder="What are you looking for?" class="search-input" style="width: 100%;">
    </div>

    <!-- Centered logo -->
    <div class="logo">
        <a href="index.php"><img src="./images/thumbnail_OliviaLogo-BLK_400x.avif" alt="Olivia"></a>
    </div>

    <!-- User links on the right -->
    <div class="user-links">
        <a href="login.php" class="icon"><i class="fas fa-user"></i><span class="text"> Login</span></a>
        <a href="cart.php" class="icon"><i class="fas fa-shopping-cart"></i><span class="text"> Cart</span></a>
    </div>
</div>
...
<div id="searchSidebar" class="search-sidebar">
    ...
    <form action="search.php" method="get">
        <button type="submit" class="search-btn"><i class="fa-solid fa-magnifying-glass fa-lg"></i></button>
